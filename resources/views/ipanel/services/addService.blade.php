      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card card-outline card-info">
            ...
            <form action="{{url('ipanel/create-services')}}" enctype='multipart/form-data' method="post" class="text-right" role="from">
            {{csrf_field()}}
            ...
            <div class="form-group">
                    ...
                    <input name="service_name" type="text" class="form-control" id="exampleInputEmail1" placeholder="أدخل إسم الخدمة ">
                </div>
