        ...
        <div class="card-body">
          <div class="row">
            ...
            <div class="col-12 col-md-12 col-lg-4 order-1 order-md-2 text-right">
              <h3 class="text-primary"><i class="fas fa-paint-brush"></i>{{$service->name}}</h3>
              <p class="text-muted">
              {{$service->description}}
                </p>
              <br>
              ...
              <div class="text-center mt-5 mb-3">
                <a href="{{url('/ipanel/edit-services/'.$service->id)}}" class="btn btn-sm btn-primary"> تعديل</a>
                <a href="{{url('/ipanel/delete-services/'.$service->id)}}" class="btn btn-sm btn-danger"> حذف</a>
              </div>
            </div>
          </div>
        </div>
