      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card card-outline card-info">
            ...
            <form action="{{url('ipanel/edit_category_values/'.$category->id)}}" enctype='multipart/form-data' method="post" class="text-right" role="from">
            {{csrf_field()}}
            ...
            <div class="form-group">
                    ...
                    <div class="input-group">
                      <div class="custom-file">
                        <input required name="category_image"
            ...
            <div class="form-group">
                ...
                <div class="form-group text-right">
                  ...
                  @foreach($paranet_services as $paranet_service)
                    <option  value="{{$paranet_service->id}}" selected="true"?{{$paranet_service->id==$category->service_id}}:"false" >{{$paranet_service->name}}</option>
                    @endforeach
                  </select>
                </div>
            ...
            <div class="form-group">
                    ...
                    <input required name="category_price" type="number" class="form-control" 
                    id="exampleInputEmail1" placeholder="أدخل سعر الفئة " value="{{$category->price}}">
                </div>

              <div class="my-3 from-group">
              <label for="exampleInputEmail1"> وصف الفئة</label>
                <textarea required name="category_description"  class="textarea" placeholder="Place some text here"
