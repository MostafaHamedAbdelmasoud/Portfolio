      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card card-outline card-info">
            ...
            <form action="{{url('ipanel/create_work')}}" enctype='multipart/form-data' method="post" class="text-right" role="from">
            {{csrf_field()}}
            ...
            <div class="form-group">
                    ...
                    <div class="input-group">
                      <div class="custom-file">
                        <input required name="work_image" type="file" class="custom-file-input" id="exampleInputFile">
            ...
            <div class="form-group">
                    ...
                    <input required name="work_name" type="text" class="form-control" id="exampleInputEmail1" placeholder="أدخل إسم الفئة ">
                </div>

                <div class="form-group text-right">
                  <label for="exampleFormControlSelect1"> نوع الفئة</label>
