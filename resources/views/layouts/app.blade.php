...
<body>
      ...
      <div class="container ">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav ml-auto ">
            ...
            <li class="nav-item ">
              <a class="nav-link" href="#home" id="home-link">الرئيسية <span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="#about" id='about-link'>عنى</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="#services" id='services-link'>الخدمات</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="#skills" id='skills-link'>المهارات</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="#works" id='works-link'>معرض الاعمال</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="#contact" id='contact-link'> اتصل بنا</a>
            </li>
            @if(Auth::User())
  ...
  <script src="{{ asset('js/bootstrap-rtl.min.js') }}" defer></script>
  <!-- <script
